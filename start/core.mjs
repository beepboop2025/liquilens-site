...
export const SERVERS = Object.freeze([
  ...
  {id: "palimpsest", name: "Palimpsest", url: "https://api.seiche.info/palimpsest/mcp", role: "China research, source changes and information controls", docs: "https://palimpsest.info/china/", prompt: "Use Palimpsest to find the current China economic evidence and its revisions. Preserve publication dates, source links, restricted or missing fields and the financial-authority boundary."},
  ...
  {id: "narcoscope", name: "NarcoScope", url: "https://narcoscope.com/mcp", role: "Official drug-market and illicit-economy evidence", docs: "https://narcoscope.com/", prompt: "Use NarcoScope to retrieve official illicit-economy research. Give the source, observation period, coverage gaps and uncertainty. Keep indicators distinct from causal claims."},
