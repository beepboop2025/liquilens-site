...
export const SERVERS = Object.freeze([
  {id: "research-data", name: "Source data: Seiche, LiquiLens & Undertow", url: "https://api.seiche.info/api/v2/research-data/mcp", role: "Funding histories, bank filings and Bitcoin/Liquid settlement with source receipts", docs: "https://liquilens.in/agents/#source-data", prompt: "Use research_catalog to choose a dataset. Resolve exact series and institution identifiers before reading a bounded page with research_observations. Retain units, event time, capture time, missing values and source receipts. Follow next_offset only when needed. Historical observations before first capture are not point-in-time history."},
  ...
  {id: "seiche-market-corpus", name: "Seiche Market Atlas Corpus", url: "https://api.seiche.info/api/v2/corpus/mcp", role: "Dataset receipts, structural inspection and rights-approved BIS records", docs: "https://seiche.info/#corpus", prompt: "Use corpus_health and corpus_catalog to discover available market datasets. Inspect source clocks, immutable object identity and publication rights before requesting bounded BIS records. Keep restricted collections metadata-only and do not treat registered datasets as live coverage."},
  ...
  {id: "myquant-app", name: "MyQuant app discovery", url: "https://myquant-app.vercel.app/mcp", role: "App capabilities and compatibility health; no access to on-device state", docs: "https://myquant-app.vercel.app/", prompt: "Read the MyQuant app capabilities and health. State its read-only discovery scope, local-only saved state and current release status. Do not infer an active news feed or a published app-store release from metadata availability."},
