...
ROUTES = (
    ...
    RouteDefinition(
        ...
        "SEICHE FUNDING / LIQUILENS COUNTERPARTY", "PAGE CUT", "2026-09-05",
    ...
    RouteDefinition(
        ...
        "OFFICIAL PUBLISHERS REMAIN AUTHORITATIVE", "PAGE CUT", "2026-09-05",
    ...
    RouteDefinition(
        ...
        "LIQUILENS INSTITUTIONS / UNDERTOW EXITS", "PAGE CUT", "2026-09-05",
        "NO BLENDED SCORE", "EVIDENCE CATALOG",
        signature_file="world-economy/evidence-catalog.json",
    ),
    RouteDefinition(
    ...
    RouteDefinition(
        ...
        "REACHABILITY IS NOT RELEASE IDENTITY", "PAGE CUT", "2026-09-05",
    ...
    RouteDefinition(
        ...
        "SEICHE / LIQUILENS / UNDERTOW / PALIMPSEST", "CATALOG CUT",
        json.loads((ROOT / "world-economy/evidence-catalog.json").read_text(encoding="utf-8"))["dateModified"],
