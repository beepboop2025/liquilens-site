...
HEAD = """<!doctype html>
<html lang="en" class="family-design">
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" href="/family-design.css"><link rel="stylesheet" href="/family-pages.css"></head>
<body class="family-page"><header class="family-header"><nav class="family-nav" aria-label="Product family"><a class="family-brand" href="/" aria-label="LiquiLens home"><svg viewBox="0 0 32 32" aria-hidden="true"><circle cx="16" cy="16" r="12"/><path d="M9 20V12M14 23V9M19 20V12M24 17V15"/></svg>LiquiLens</a><div class="family-products"><a href="/" aria-current="page">LiquiLens</a><a href="https://seiche.info/">Seiche</a><a href="https://liquilens-undertow.com/">Undertow</a></div><a class="family-connect" href="/developers/institutions/">For agents</a></nav></header>
...
BASE_SITEMAP = [
    ...
    ("/world-economy/", "2026-09-05", "weekly", "0.95"),
    ("/money-markets/", "2026-09-05", "weekly", "0.95"),
    ("/capital-markets/", "2026-09-05", "weekly", "0.95"),
    ("/china-economy/", "2026-09-05", "weekly", "0.95"),
    ("/protocol/", "2026-09-02", "monthly", "0.9"),
    ("/protocol/trade-safety/", "2026-09-02", "monthly", "0.95"),
    ("/protocol/trade-safety/specification.md", "2026-09-02", "never", "0.8"),
